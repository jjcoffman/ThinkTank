...
public final class ScenarioDefinition{
	...
	private void genEnts2(Scenario scenario){
		...
		pot.getObj().setLocalTranslation(-2.73087E-4f, 0.0f, -0.13999975f);
		...
		plant.getObj().setLocalTranslation(-0.05833201f, 0.0f, 0.15098202f);
	...
	private void genEnts3(Scenario scenario){
		...
		//add pots
		Pot pot = EntityFactory.createPot();
		pot.getObj().setLocalTranslation(0.044705704f, 0.0f, 0.18138747f);
		pot.getObj().setLocalScale(0.0762f, 0.0762f, 0.0762f);
		pot.getObj().rotate(0, 90, 0);
		//add pots
		scenario.addEnvironmentObject(pot);
		Plant plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.09556306f, 0.0f, -0.152865f);
	...
	private void genEnts4(Scenario scenario){
		...
		//add pots
		Pot pot = EntityFactory.createPot();
		pot.getObj().setLocalTranslation(0.012422485f, 0.0f, 0.1294051f);
		pot.getObj().setLocalScale(0.0762f, 0.0762f, 0.0762f);
		//TODO set rotation
		scenario.addEnvironmentObject(pot);
		//add plants
		Plant plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.15475345f, 0.0f, -0.06125257f);
		plant.getObj().setLocalScale(0.029526312f, 0.029542202f, 0.028008288f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.12913f, 0.0f, -0.26037896f);
		plant.getObj().setLocalScale(0.03936841f, 0.0393896f, 0.03734438f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.049622167f, 0.0f, -0.23982519f);
		plant.getObj().setLocalScale(0.01813019f, 0.018139949f, 0.01719807f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.0048237303f, 0.0f, -0.35799065f);
		plant.getObj().setLocalScale(0.031080326f, 0.031097054f, 0.029482407f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.13064393f, 0.0f, -0.3425547f);
		plant.getObj().setLocalScale(0.032116335f, 0.03213362f, 0.030465152f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.117809236f, 0.0f, 0.077142775f);
		plant.getObj().setLocalScale(0.032116335f, 0.03213362f, 0.030465152f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.13215373f, 0.0f, -0.081457675f);
		plant.getObj().setLocalScale(0.03367035f, 0.033688474f, 0.03193927f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.15309826f, 0.0f, -0.22149652f);
		plant.getObj().setLocalScale(0.026936281f, 0.026950778f, 0.025551418f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.1495902f, 0.0f, 0.21029106f);
		plant.getObj().setLocalScale(0.032116335f, 0.03213362f, 0.030465152f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.029375998f, 0.0f, 0.32005772f);
		plant.getObj().setLocalScale(0.019684205f, 0.0196948f, 0.01867219f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.10064329f, 0.0f, 0.32980508f);
		plant.getObj().setLocalScale(0.020720217f, 0.020731369f, 0.019654937f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.12152052f, 0.0f, 0.21939106f);
	...
	private void genEnts5(Scenario scenario){
		...
		//add pots
		Pot pot = EntityFactory.createPot();
		pot.getObj().setLocalTranslation(-0.06697098f, 0.0f, -0.15720972f);
		pot.getObj().setLocalScale(0.0762f, 0.0762f, 0.0762f);
		pot.getObj().rotate(0, 160, 0);
		scenario.addEnvironmentObject(pot);
		pot = EntityFactory.createPot();
		pot.getObj().setLocalTranslation(0.0070289057f, 0.0f, 0.15984556f);
		pot.getObj().setLocalScale(0.0762f, 0.0762f, 0.0762f);
		pot.getObj().rotate(0, 0, 0);
		scenario.addEnvironmentObject(pot);
		//add plants
		Plant plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.007075117f, 0.0f, -0.08499807f);
		plant.getObj().setLocalScale(0.036778387f, 0.036798183f, 0.034887515f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.053520672f, 0.0f, -0.009175407f);
		plant.getObj().setLocalScale(0.023310244f, 0.02332279f, 0.022111805f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.02953006f, 0.0f, 0.06259964f);
		plant.getObj().setLocalScale(0.036778387f, 0.036798183f, 0.034887515f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
	...
	private void genEnts6(Scenario scenario){
		...
		//add pots
		Pot pot = EntityFactory.createPot();
		pot.getObj().setLocalTranslation(0.1081209f, 0.0f, 0.24085239f);
		pot.getObj().setLocalScale(0.0762f, 0.0762f, 0.0762f);
		pot.getObj().rotate(0, 0.5f, 0);
		scenario.addEnvironmentObject(pot);
		pot = EntityFactory.createPot();
		pot.getObj().setLocalTranslation(-0.10819905f, 0.0f, -0.2308527f);
		pot.getObj().setLocalScale(0.0762f, 0.0762f, 0.0762f);
		pot.getObj().rotate(0, 10, 0);
		scenario.addEnvironmentObject(pot);
		//add plants
		Plant plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(0.09116956f, 0.0f, -0.14929199f);
		plant.getObj().setLocalScale(0.036778387f, 0.036798183f, 0.034887515f);
		//TODO set rotation
		scenario.addEnvironmentObject(plant);
		plant = EntityFactory.createPlant();
		plant.getObj().setLocalTranslation(-0.11015297f, 0.0f, 0.019139629f);
